...
local ConfigDefault = {
    ...
    --- @field other_max_lines integer Fold generic/MCP/meta tool-result bodies (non-execute) exceeding this many lines. Set to 0 to disable folding for these.
    ...
    --- @field auto_approve "allow"|"read-only"|nil Which Bash patterns to auto-approve:
    ---   "allow" — read_only + safe_write patterns
    ---   "read-only" — only read_only patterns
